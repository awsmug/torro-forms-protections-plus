...
namespace awsmug\TorroFormsProtectionsPlus;

use awsmug\TorroFormsProtectionsPlus\Element_Types\Date;
use awsmug\TorroFormsProtectionsPlus\Element_Types\Autocomplete;
use awsmug\TorroFormsProtectionsPlus\Actions\Frontend_Posting;
...
class Extension extends Extension_Base {
	...
	protected function load_base_properties() {
		...
		$this->project_name = 'TorroFormsProtectionsPlus';
	}
	...
	protected function load_textdomain() {
		$this->load_plugin_textdomain( 'torro-forms-protections-plus', '/languages' );
	}
	...
	protected function instantiate_services() {
		...
		$this->parent_plugin->template()->register_location( 'torro-forms-protections-plus', $this->path( 'templates/' ) );
	}
