...
namespace awsmug\TorroFormsProtectionsPlus\Actions;
...
class Frontend_Posting extends API_Action {
	...
	protected function bootstrap() {
		...
		$this->title = __( 'Frontend Posting', 'torro-forms-protections-plus' );
	...
	protected function get_available_structures_and_routes() {
		...
		return array(
			self::STRUCTURE_SLUG => array(
				'title'               => __( 'Local REST API', 'torro-forms-protections-plus' ),
